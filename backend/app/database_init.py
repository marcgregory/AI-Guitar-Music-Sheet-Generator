...
def _seed_demo_transcription() -> None:
    ...
    try:
        with SessionLocal() as session:
            ...
            demo.processing_status = "completed"
            demo.queue_position = 0
            demo.estimated_wait_time = 0
            demo.celery_task_id = None
            demo.modal_dispatch_status = None
            demo.modal_job_type = None
            demo.modal_dispatched_at = None
            demo.modal_request_id = None
            demo.modal_retry_at = None
            demo.modal_retry_count = 0
